...
namespace CodeEurope.Publisher
{
    ...
    {
        private const string EventHubConnectionString = "Endpoint=sb://codeeurope-euw-eventhub-namespace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=yafH3GZzsSadtbYJLWwcd13grNpBsFuP6j6izP8PsoQ=";
        private const string EventHubName = "codeeurope-euw-eventhub";
